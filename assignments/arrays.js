...
console.log("Car number:" + inventory[32].id, "Car Year:"+ inventory[32].car_year, "Car Make:" + inventory[32].car_make, "Car Model:" + inventory[32].car_model);
...
/* HOW I DID IT: did a for loop to loop over the inventory arrays, then pushed each car_model in the inventory arrays (inventory[i].car_model) to the new array: carModels
then in the console.log, we put .sort() to sort the models in alphabetical order. */ 
...
/*HOW I DID IT: for loop to go through everything, then made an "if" statement to see if the car year is older than 2000 (inventory[i].car_year < 2000) 
then push that car year to the new array oldCars, has to be in {}. code: {oldCars.push(inventory[i].car_year)}*/
console.log(oldCars);  
